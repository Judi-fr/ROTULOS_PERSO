...
from .views import AdminDocumentListView, DocumentViewSet, UploadedLabelFileViewSet
...
router.register(r"documentos", UploadedLabelFileViewSet, basename="documento")
